...
public final class Constants {
    ...
    public static class Chassis {
        ...
        public static final double FR_OFFSET = (-2.38)+0/*+0.16*/ - (2 * Math.PI) + (Math.PI);

        /** The offset of the Front Left Motor */
        public static final double FL_OFFSET = (9.401)+0.045647/*+0.08*/ - (Math.PI / 2);

        /** The offset of the Back Right Motor */
        public static final double BR_OFFSET =  (-3.345)+0.009/*+0.19*/ - (Math.PI / 2) - (2 * Math.PI);



        /** The offset of the Back Left Motor */
        public static final double BL_OFFSET = (6.12)+0.339057/*+0.43*/ - (2 * Math.PI) - (Math.PI / 2);
