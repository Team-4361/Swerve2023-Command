...
import static frc.robot.DriveConstants.PID.ANGLE_AUTO_PID;
import static frc.robot.DriveConstants.PID.Y_AUTO_PID;
...
// Pose2d consumer, used to reset odometry at the beginning of auto
          new PIDConstants(Y_AUTO_PID.p, Y_AUTO_PID.i, Y_AUTO_PID.d),
// PID constants to correct for translation error (used to create the X and Y PID controllers)
          new PIDConstants(ANGLE_AUTO_PID.p, ANGLE_AUTO_PID.i, ANGLE_AUTO_PID.d),
